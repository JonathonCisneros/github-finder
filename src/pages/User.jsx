          ...
          <div className='col-span-2'>
            <div className='mb-6'>
              <h1 className='text-xl card-title'>
                { name }
                <div class='badge badge-success mr-1 ml-2'>{ type }</div>
              </h1>
              ...
              { blog && (
                <div className='stat'>
                  ...
                  <div className='stat-value text-base'>
                    <a href={ websiteURL} target='_blank' rel='noreferrer'>{ blog }</a>
                  </div>
                </div>
              )}
              { twitter_username && (
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4'>
            <div className='stat'>
              <div className='stat-figure text-secondary'>
                <FaUsers class='text-3xl md:text-5xl' />
              </div>
            ...
            <div className='stat'>
              <div className='stat-figure text-secondary'>
                <FaUserFriends class='text-3xl md:text-5xl' />
              </div>
              <div className='stat-title pr-5'>
                Following
              </div>
            ...
            <div className='stat'>
              <div className='stat-figure text-secondary'>
                <FaCodepen class='text-3xl md:text-5xl' />
              </div>
              <div className='stat-title pr-5'>
                Public Repos
              </div>
            ...
            <div className='stat'>
              <div className='stat-figure text-secondary'>
                <FaStore class='text-3xl md:text-5xl' />
              </div>
              <div className='stat-title pr-5'>
                Public Gists
              </div>
